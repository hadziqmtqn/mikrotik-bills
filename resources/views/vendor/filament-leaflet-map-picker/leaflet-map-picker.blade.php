...
>
    <div
            wire:ignore
            ax-load
            x-load-css="[@js(FilamentAsset::getStyleHref('leaflet-map-picker', 'afsakar/filament-leaflet-map-picker'))]"
            ax-load-src="{{ FilamentAsset::getAlpineComponentSrc('leaflet-map-picker', 'afsakar/filament-leaflet-map-picker') }}"
            ...
            <div class="p-4 bg-gray-50 border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600"
                ...
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="h-5 w-5 text-gray-500 mr-2 dark:text-gray-200"
                         fill="none"
                         viewBox="0 0 24 24"
                         stroke="currentColor">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-200">
                        ...
                        <span class="font-medium"
                              x-text="lat ? lat.toFixed(6) : ''"></span>,
                        <span class="font-medium"
                              x-text="lng ? lng.toFixed(6) : ''"></span>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4">
                ...
                >
                    <ul class="overflow-auto">
                        <template
                                x-for="(result, index) in localSearchResults"
                                :key="index">
                                ...
                                >
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-800 dark:text-gray-200"
                                           x-text="result.display_name || result.name"></p>
                                    </div>
                                </button>
                            </li>
                        </template>
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg"
                         class="h-6 w-6 mx-auto text-gray-400 dark:text-gray-300"
                         fill="none"
                         viewBox="0 0 24 24"
                         stroke="currentColor">
                        <path stroke-linecap="round"
