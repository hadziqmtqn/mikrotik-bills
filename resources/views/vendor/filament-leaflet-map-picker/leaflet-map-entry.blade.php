@php
    use Filament\Support\Facades\FilamentAsset;$id = $getId();
...
>
    <div
            ...
            ax-load-src="{{ FilamentAsset::getAlpineComponentSrc('leaflet-map-picker-entry', 'afsakar/filament-leaflet-map-picker') }}"
                ...
                <div class="flex items-center">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-200">
                        ...
                        <span class="font-medium"
                              x-text="location ? location.lat.toFixed(6) : ''"></span>,
                        <span class="font-medium"
                              x-text="location ? location.lng.toFixed(6) : ''"></span>
                    </p>
                </div>
            </div>
        </div>
