...
>
    <div
            ...
            @endif
            x-ignore
            x-load-src="{{ FilamentAsset::getAlpineComponentSrc('dateRangeComponent', 'malzariey/filament-daterangepicker-filter') }}"
            x-ref="container"
    ...
    >
        <x-filament::input.wrapper
                ...
                :attributes="prepare_inherited_attributes($getExtraAttributeBag())->class([
                    'overflow-hidden',
                ])"
        >
            <button
