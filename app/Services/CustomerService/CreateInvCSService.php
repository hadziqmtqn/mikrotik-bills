...
{
    public static function handle($invoiceId, CustomerService $customerService, bool $includeBill, array $extraCosts = null): InvCustomerService
    {
        ...
        $invCustomerService->extra_costs = $extraCosts;
